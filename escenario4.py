...
def topology(args):
    ...
    sta2 = net.addStation('sta2', ip='10.10.0.2/24', position='75,300,0', mac='02:00:00:00:65:02', **kwargs)
    sta3 = net.addStation('sta3', ip='10.10.0.3/24', position='125,250,0', mac='02:00:00:00:65:03', **kwargs)
    sta4 = net.addStation('sta4', ip='10.10.0.4/24', position='175,300,0', mac='02:00:00:00:65:04', **kwargs)
    sta5 = net.addStation('sta5', ip='10.10.0.5/24', position='225,250,0', mac='02:00:00:00:65:05', **kwargs)
    sta6 = net.addStation('sta6', ip='10.10.0.6/24', position='275,300,0', mac='02:00:00:00:65:06', **kwargs)
    sta7 = net.addStation('sta7', ip='10.10.0.7/24', position='325,250,0', mac='02:00:00:00:65:07', **kwargs)
    sta8 = net.addStation('sta8', ip='10.10.0.8/24', position='375,300,0', mac='02:00:00:00:65:08', **kwargs)
    sta9 = net.addStation('sta9', ip='10.10.0.9/24', position='425, 250, 0', mac='02:00:00:00:65:09',  **kwargs)
    sta10 = net.addStation('sta10', ip='10.10.0.10/24', mac='02:00:00:00:65:10', position='475,250,0', **kwargs)
